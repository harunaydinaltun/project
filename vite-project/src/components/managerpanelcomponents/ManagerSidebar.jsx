...
export const ManagerSidebar = ({ setActiveTab }) => {
      ...
      {isOpen && (
        <div>
          ...
          <button
            type="button"
            className="w-full text-left px-4 py-3 rounded-lg text-slate-700 font-medium hover:bg-slate-100 hover:text-slate-900 active:scale-[0.99] transition-all duration-150 cursor-pointer"
            onClick={() => setActiveTab("activeres")}
          >
            Aktif Rezervasyonları Görüntüle
          </button>
          <button
            type="button"
            className="w-full text-left px-4 py-3 rounded-lg text-slate-700 font-medium hover:bg-slate-100 hover:text-slate-900 active:scale-[0.99] transition-all duration-150 cursor-pointer"
            onClick={() => setActiveTab("confirmedres")}
          >
